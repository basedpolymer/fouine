...
| Fouine ne trouve pas « … » | « Ses documents restent consultables. Si vous l'avez déplacé ou renommé, retirez-le de vos dossiers puis ajoutez-le de nouveau depuis son nouvel emplacement. » | le dossier a été déplacé, renommé ou supprimé | Revérifier |
| Fouine ne parvient pas à ouvrir les fichiers de « … » | « Ses documents restent consultables. Vérifiez que le dossier contient toujours vos documents et que son disque fonctionne, puis revérifiez. » | aucun fichier du dossier ne s'ouvre, ou son disque répond par une erreur | Revérifier |
